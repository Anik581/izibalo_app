...
*/
      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        if (self.opt.boxzoom&&!self.ispage&&!cap.isieold) {
          ...
          self.zoom = $(zoom);
          self.zoom.css({"cursor":"pointer",'z-index':self.zindex,'backgroundImage':"url('/assets/zoomico.png')",'height':18,'width':18,'backgroundPosition':'0px 0px'});
...
// $(document).on('page:load', init_user_stats);
